...
2. [كتابة و قراءة أطر البيانات، تصديرها و إدخالها](## 2. كتابة و قراءة أطر البيانات، تصديرها و إدخالها)
  - [كتابة البيانات إلى ملفات](### كتابة البيانات إلى ملفات)
    - [تصدير البيانات إلى ملف نصي (`*.txt`)](#### 1. تصدير البيانات إلى ملف نصي `*.txt`)
    - [تصدير البيانات إلى ملف (`*.csv`)](#### 2. تصدير البيانات إلى ملف `*.csv`)
  - [قراءة البيانات على آر](### قراءة البيانات على آر)
    - [قراءة ملفات النصوص (`*.txt`)](#### 1. قراءة ملفات النصوص `*.txt`)

3. [قراءة ملفات CSV (`*.csv`)](#### 2. قراءة ملفات `*.csv`)
  - [الوصول إلى عناصر إطار البيانات](## 3. الوصول إلى عناصر إطار البيانات)
...
4.[معلومات مختلفة عن أطر البيانات](## 4. معلومات مختلفة عن أطر البيانات)
